...
const recoveryPasswordControllerEstudiantes = {}

recoveryPasswordControllerEstudiantes.requestCode = async (req,res) => {
    try {
...
recoveryPasswordControllerEstudiantes.verifyCode = async (req, res) => {
    try {
        const {code} = req.body
...
recoveryPasswordControllerEstudiantes.newPassword = async (req, res) => {
    try {
...
export default recoveryPasswordControllerEstudiantes;